<html>
	...
	<!--  window.self.close(); -->
	<body onLoad=" window.print(); " style=" font-size:10pt; font-family:arial; ">
		...
		<center>
			<p style="font-size: 7pt;">Escanea este código para generar tu factura electrónica.</p>
			<p style="font-size: 6pt; text-transform: lowercase;"> {{ $url_qr }}</p>
			{!! $qrCode !!}
			
			<p style="font-size: 7pt;">Para generar tu factura electrónica, escanea este código QR con tu celular. Sigue las instrucciones que aparecerán en pantalla para completar el proceso.</p>
		</center>
