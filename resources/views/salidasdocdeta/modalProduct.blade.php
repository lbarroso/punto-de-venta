		...
		<div class="modal-content">
			...
			<form id="formProduct">
				...
				<div class="modal-body">
                    ...
                    <div class="form-group">
						<label for="artprcosto">P.Venta $</label>
						<input type="text" name="artprventa" id="Purchasesartprventa" onfocus="this.select()" class="form-control" onKeyPress="return handleEnter(this, event)">
					</div>
